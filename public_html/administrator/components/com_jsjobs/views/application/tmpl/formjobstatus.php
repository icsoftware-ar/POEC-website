...
Joomla.submitbutton = function(task){
        if (task == ''){
                ...
                if (task == 'savejobstatussave' || task == 'savejobstatusandnew' || task == 'savejobstatus' ){
...
function submitbutton(pressbutton) {
	...
	if (pressbutton == 'savejobstatussave' || pressbutton == 'savejobstatusandnew' || pressbutton == 'savejobstatus' ){
		returnvalue = validate_form(document.adminForm);
	}else returnvalue  = true;
