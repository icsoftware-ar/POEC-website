...
Joomla.submitbutton = function(task){
        if (task == ''){
			...
			if (task == 'savejobsalaryrangetypesave' || task == 'savejobsalaryrangetypeandnew' || task == 'savejobsalaryrangetype' ){
...
function submitbutton(pressbutton) {
	...
	if (pressbutton == 'savejobsalaryrangetypesave' || pressbutton == 'savejobsalaryrangetypeandnew' || pressbutton == 'savejobsalaryrangetype' ){
		returnvalue = validate_form(document.adminForm);
	}else returnvalue  = true;
...
<table width="100%" >
	...
	<tr>
		...
		<input type="submit" class="button" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('JS_SAVE'); ?>" />
			...
			<input type="hidden" name="task" value="savejobsalaryrangetype" />
