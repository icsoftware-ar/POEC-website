...
Joomla.submitbutton = function(task){
        if (task == ''){
                ...
                if (task == 'savejobcurrencysave' || task == 'savejobcurrencyandnew' || task == 'savejobcurrency' ){
...
function submitbutton(pressbutton) {
	...
	if (pressbutton == 'savejobcurrencysave' || pressbutton == 'savejobcurrencyandnew' || pressbutton == 'savejobcurrency' ){
		returnvalue = validate_form(document.adminForm);
	}else returnvalue  = true;
...
<table width="100%" >
	...
	?>
	 <tr>
        <td width="100%" align="center"><?php echo JText::_('JS_TITLE'); ?> : 
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="inputbox required" type="text" name="title" size="40" maxlength="255" value="<?php if(isset($this->currency)) echo $this->currency->title; ?>" />
        </td>
      </tr>
	 <tr>
        <td width="100%" align="center"><?php echo JText::_('JS_CURRENCY_SYMBOL'); ?> : 
		  <input class="inputbox required" type="text" name="symbol" size="40" maxlength="255" value="<?php if(isset($this->currency)) echo $this->currency->symbol; ?>" />
        </td>
      </tr>
	 <tr>
        <td width="100%" align="center"><?php echo JText::_('JS_CODE'); ?> : 
		  <input class="inputbox required" type="text" name="code" size="40" maxlength="255" value="<?php if(isset($this->currency)) echo $this->currency->code; ?>" />
        </td>
      </tr>
      <tr>
	...
	<tr>
		...
		<input type="submit" class="button" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('JS_SAVE'); ?>" />
			...
			<input type="hidden" name="task" value="savejobcurrency" />
