...
Joomla.submitbutton = function(task){
        if (task == ''){
                ...
                if (task == 'savejobhighesteducationsave' || task == 'savejobhighesteducationandnew' || task == 'savejobhighesteducation' ){
...
function submitbutton(pressbutton) {
	...
	if (pressbutton == 'savejobhighesteducationsave' || pressbutton == 'savejobhighesteducationandnew' || pressbutton == 'savejobhighesteducation' ){
		returnvalue = validate_form(document.adminForm);
	}else returnvalue  = true;
...
<table width="100%" >
	...
	<tr>
		...
		<input type="submit" class="button" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('JS_SAVE'); ?>" />
			...
			<input type="hidden" name="task" value="savejobhighesteducation" />
