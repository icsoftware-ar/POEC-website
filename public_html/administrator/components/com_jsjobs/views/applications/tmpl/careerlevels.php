...
JRequest :: setVar('layout', 'careerlevels');
$_SESSION['cur_layout']='careerlevels';
...
<div id="jsjobs_info_heading"><?php echo JText::_('JS_CAREER_LEVELS'); ?></div>	
			...
			$k = 0;
				...
				$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editcareerlevels&cid[]='.$row->id);
				?>
