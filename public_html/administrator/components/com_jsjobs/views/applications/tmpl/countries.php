	...
	<tr>
		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editjobcountry&cid[]='.$row->id);
				?>
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td align="center">
						...
						?>
						<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','<?php echo $functionname; ?>')">
						
							<img src="../components/com_jsjobs/images/<?php echo $img;?>" width="16" height="16" border="0" alt="<?php echo $alt; ?>" />
						</a>	
					</td>
					<td><a href="index.php?option=com_jsjobs&task=view&layout=states&ct=<?php echo $row->id; ?>"><?php echo JText::_('JS_STATES'); ?></a></td>
					<td><a href="index.php?option=com_jsjobs&task=view&layout=cities&ct=<?php echo $row->id; ?>"><?php echo JText::_('JS_CITIES'); ?></a></td>
				</tr>
				<?php
				$k = 1 - $k;
			}
