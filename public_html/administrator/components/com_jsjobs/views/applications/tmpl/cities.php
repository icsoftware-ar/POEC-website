	...
	<tr>
		...
		<td width="100%" valign="top">
			...
			<table class="adminlist" border="0">
				<thead>
					...
					?>
						...
						<a href="index.php?option=com_jsjobs&task=view&layout=states&ct=<?php echo $countryid; ?>" ><?php echo JText::_('JS_STATES'); ?></a> > <?php echo JText::_('JS_CITIES'); ?>
			...
			$k = 0;
				...
				$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editjobcity&cid[]='.$row->id);
				?>
