...
JRequest :: setVar('layout','featuredcompaniesqueue');
$_SESSION['cur_layout']='featuredcompaniesqueue';
...
<table width="100%">
	...
	<table>
				<tr>
					...
					&nbsp;&nbsp;&nbsp;</td>
					<td>
						<button onclick="document.getElementById('searchcompany').value='';document.getElementById('searchemployerpackage').value='';document.getElementById('searchcountry').value='';this.form.submit();"><?php echo JText::_( 'Reset' ); ?></button>
					</td>
				</tr>
			</table>
			...
			$k = 0;
				$approvetask 	= 'featuredcompanyapprove';
				$approveimg 	= 'tick.png';
				$rejecttask 	= 'featuredcompanyreject';
