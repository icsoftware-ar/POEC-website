...
JRequest :: setVar('layout', 'experience');
$_SESSION['cur_layout']='experience';
...
<div id="jsjobs_info_heading"><?php echo JText::_('JS_EXPERIENCE'); ?></div>	
			...
			$k = 0;
				...
				$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editjobexperience&cid[]='.$row->id);
				?>
