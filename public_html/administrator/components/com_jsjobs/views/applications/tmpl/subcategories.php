...
JRequest :: setVar('layout', 'subcategories');
$_SESSION['cur_layout']='subcategories';
	...
	<tr>
		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editsubcategories&cid[]='.$row->id);
				?>
					...
					<td align="center">
						<?php
                                            if($row->status == 1){ // published ?>
                                                <a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','unpublishsubcategories')">
                                                        <img src="../components/com_jsjobs/images/tick.png" width="16" height="16" border="0" alt="<?php echo JText::_( 'Published' ); ?>" /></a>
                                            <?php }else{ // published ?>
                                                <a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','publishsubcategories')">
