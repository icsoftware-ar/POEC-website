...
JRequest :: setVar('layout', 'employerpaymenthistory');
$_SESSION['cur_layout']='employerpaymenthistory';
		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td><a href="index.php?option=com_jsjobs&task=view&layout=employerpaymentdetails&pk=<?php echo $row->id; ?>"><?php echo $row->packagetitle; ?></a></td>
