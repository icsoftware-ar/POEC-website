...
$_SESSION['cur_layout']='addtogoldresumes';
		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td>
						<a href="index.php?option=com_jsjobs&view=application&layout=formgoldresume&rd=<?php echo $row->id;?>"><?php echo JText::_('JS_ADD_TO_GOLD_RESUMES');?></a>
					</td>
			...
			<input type="hidden" name="layout" value="addtogoldresumes" />
