...
JRequest :: setVar('layout', 'goldjobs');
$_SESSION['cur_layout']='goldjobs';
...
<table width="100%">
	<tr>
		...
		<td width="100%" valign="top">
				<div id="jsjobs_info_heading"><?php echo JText::_('JS_GOLD_JOBS'); ?></div>
			...
			<table>
				<tr>
					...
					<td>
						<button onclick="document.getElementById('searchtitle').value='';document.getElementById('searchcompany').value='';document.getElementById('searchemployerpackage').value='';this.form.submit();"><?php echo JText::_( 'Reset' ); ?></button>
					</td>
				</tr>
			</table>
