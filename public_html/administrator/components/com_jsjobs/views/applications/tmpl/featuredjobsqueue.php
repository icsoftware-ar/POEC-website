...
JRequest :: setVar('layout', 'featuredjobsqueue');
$_SESSION['cur_layout']='featuredjobsqueue';
		...
		<td width="100%" valign="top">
			...
			<table>
				<tr>
					...
					<td>
						<button onclick="document.getElementById('searchtitle').value='';document.getElementById('searchcompany').value='';document.getElementById('searchemployerpackage').value='';this.form.getElementById('searchjobcategory').value='';this.form.getElementById('searchjobtype').value='';this.form.getElementById('searchjobstatus').value='';this.form.submit();"><?php echo JText::_( 'Reset' ); ?></button>
					</td>
				</tr>
			</table>
			...
			$k = 0;
				$approvetask 	= 'featuredjobapprove';
				$approveimg 	= 'tick.png';
				$rejecttask 	= 'featuredjobreject';
				...
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td >
						<?php echo date( $this->config['date_format'],strtotime($row->packagecreated)); ?>
					</td>
