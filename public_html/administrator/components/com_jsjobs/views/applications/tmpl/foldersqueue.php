...
JRequest :: setVar('layout', 'foldersqueue');
$_SESSION['cur_layout']='foldersqueue';
...
<table width="100%" >
	<tr>
		...
		<td width="100%" valign="top">
				<div id="jsjobs_info_heading"><?php echo JText::_('JS_FOLDERS_QUEUE'); ?></div>
			...
			$k = 0;
				...
				for ($i=0, $n=count( $this->items ); $i < $n; $i++){
					...
					<td style="text-align: center;">
                                            <strong><?php if ($row->status == 0) { echo '<font color="red">  '. JText::_('JS_PENDDING'). '</font>';}  ?></strong>
					</td>
					<td style="text-align: center;">
                                                <a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','publishfolder')">
                                                <img src="../components/com_jsjobs/images/tick.png" width="16" height="16" border="0" alt="<?php echo JText::_( 'PUBLISH' ); ?>" /></a>
                                                &nbsp;&nbsp; - &nbsp;&nbsp
                                                <a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','unpublishfolder')">
