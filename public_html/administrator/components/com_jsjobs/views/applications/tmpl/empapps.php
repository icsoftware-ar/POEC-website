		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td style="text-align: center;">
						<?php if($row->isgoldresume==1) { ?>
							<img src="../components/com_jsjobs/images/gold.png" width="12" height="12" border="0" title="<?php echo JText::_('JS_GOLD_RESUME'); ?>" />
						<?php }else{?>	
							<a href="index.php?option=com_jsjobs&task=savegoldresume&id=<?php echo $row->id; ?>">
								<img src="../components/com_jsjobs/images/addgold.png" width="12" height="12" border="0" title="<?php echo JText::_('JS_ADD_TO_GOLD_RESUMES'); ?>" /></a>
							</a>
						<?php }?>	

						<?php if($row->isfeaturedresume==1) { ?>
							<img src="../components/com_jsjobs/images/featured.png" width="12" height="12" border="0" title="<?php echo JText::_('JS_FEATURED_RESUME'); ?>" />
						<?php }else{?>	
							<a href="index.php?option=com_jsjobs&task=savefeaturedresume&id=<?php echo $row->id; ?>">
								<img src="../components/com_jsjobs/images/addfeatured.png" width="12" height="12" border="0" title="<?php echo JText::_('JS_ADD_TO_FEATURED_RESUMES'); ?>" /></a>
							</a>
						<?php }?>	
					...
					<td style="text-align: center;">
							<a href="javascript:void(0);" onclick="return confirmdeleteresume('cb<?php echo $i;?>','<?php echo $resumedeletetask;?>');" >
