...
JRequest :: setVar('layout', 'salaryrangetype');
$_SESSION['cur_layout']='salaryrangetype';
	...
	<tr>
		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editjobsalaryrangrtype&cid[]='.$row->id);
				?>
