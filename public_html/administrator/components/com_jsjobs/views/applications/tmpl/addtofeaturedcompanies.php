...
JRequest :: setVar('layout', 'featuredcompanies');
$_SESSION['cur_layout']='featuredcompanies';
...
<table width="100%" >
	<tr>
		...
		<td width="100%" valign="top">
			...
			<form action="index.php?option=com_jsjobs&view=applications&layout=addtofeaturedcompanies" method="POST" name="adminForm" id="adminForm">
			...
			$k = 0;
				...
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td>
						<a href="index.php?option=com_jsjobs&view=application&layout=formfeaturedcompany&md=<?php echo $row->id;?>"><?php echo JText::_('JS_ADD_TO_FEATURED_COMPANIES');?></a>
					</td>
			...
			<input type="hidden" name="layout" value="addtofeaturedcompanies" />
