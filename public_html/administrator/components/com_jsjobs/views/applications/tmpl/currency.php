...
JRequest :: setVar('layout', 'currency');
$_SESSION['cur_layout']='currency';
			...
			<form action="index.php" method="post" name="adminForm" id="adminForm">
				<table class="adminlist" border="0">
					...
					for ($i=0, $n=count( $this->items ); $i < $n; $i++)
					{
						...
						$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editjobcurrency&cid[]='.$row->id);
						?>
						<tr valign="top" class="<?php echo "row$k"; ?>">
							...
							<td align="center">
								...
								<?php }else{ ?>
									<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>',' makedefaultcurrency')">
