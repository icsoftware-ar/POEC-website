...
JRequest :: setVar('layout', 'folder_resumes');
$_SESSION['cur_layout']='folder_resumes';
 $document =& JFactory::getDocument();
	...
	<tr>
		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				$resumelink = 'index.php?option=com_jsjobs&view=application&layout=view_resume&rd='.$row->appid.'&fd='.$this->fd;
				?>
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td style="text-align: center;">
						<?php 
							echo "<a href='".$resumelink ."'>".JText::_('JS_RESUME')."</a>";
						?>
					</td>
				</tr>
                        <tr valign="top" class="<?php echo "row$k"; ?>">
