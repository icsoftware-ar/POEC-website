...
DROP TABLE IF EXISTS #__js_job_paymentinfo;
DROP TABLE IF EXISTS #__js_job_salaryrange;
DROP TABLE IF EXISTS #__js_job_paymentmethods;
...
DROP TABLE IF EXISTS #__js_job_paymentmethodlinks;
