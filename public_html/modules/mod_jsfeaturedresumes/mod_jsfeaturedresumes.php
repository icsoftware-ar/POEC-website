 ...
 * Created on:	Nov 29, 2009
 ^
 + Project: 		JS Jobs 
 * File Name:	module/jsfeaturedresume.php
 ^ 
...
if (isset($resumes)) { 
	if($listingstyle == 1){ //vertical listing
		...
		if ($sliding == 1) {
			...
			<script type="text/javascript" language=Javascript>
				jQuery(document).ready(function(){
					jQuery("marquee#mod_jsfeaturedresume").marquee("pointer").mouseover(function () {
			...
			$contents =  '<marquee id="mod_jsfeaturedresume" direction="up" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
		...
		if ($sliding == 1) {
			...
			$contents =  '<marquee id="mod_jsfeaturedresume"  scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
		}
		echo $contents;
