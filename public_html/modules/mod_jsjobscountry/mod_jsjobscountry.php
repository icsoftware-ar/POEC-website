...
$showonlycountryhavejobs = $params->get('scohj', 1);
...
if ($countries) { 
	...
	if ($sliding == 1) {
		...
		if($slidingdirection == 1 ){
			...
			$contents =  '<marquee id="mod_jsjobscountry"  direction="up" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
			...
			$contents =  '<marquee id="mod_jsjobscountry"  scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
		}
		$contents .= '
		<script type="text/javascript" language=Javascript>
			jQuery(document).ready(function(){
				jQuery("marquee#mod_jsjobscountry").marquee("pointer").mouseover(function () {
