...
$showonlystatehavejobs = $params->get('ssthj', 1);
...
if ($states) { 
	...
	if ($sliding == 1) {
		...
		if($slidingdirection == 1 ){
			...
			$contents =  '<marquee id="mod_jsjobsstates"  direction="up" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
			...
			$contents =  '<marquee id="mod_jsjobsstates"  scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
		}
		$contents .= '
		<script type="text/javascript" language=Javascript>
			jQuery(document).ready(function(){
				jQuery("marquee#mod_jsjobsstates").marquee("pointer").mouseover(function () {
