 ...
 * Created on:	Nov 29, 2009
 ^
 + Project: 		JS Jobs 
 * File Name:	module/jsgoldcompanies.php
 ^ 
...
if (isset($companies)) { 
	if($listingstyle == 1){ //horizontal listing    //scs   but in xml it is verticle
		$top = "";
		...
		if ($sliding == 1) {
			...
			<script type="text/javascript" language=Javascript>
				jQuery(document).ready(function(){
					jQuery("marquee#mod_jsgoldcompanies").marquee("pointer").mouseover(function () {
			...
			$contents =  '<marquee id="mod_jsgoldcompanies"  direction="up" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
	   ...
	   $contents = '<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">';
		...
		if($sliding == 1){
			...
			$contents =  '<marquee id="mod_jsgoldcompanies" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
		}
		//sce
