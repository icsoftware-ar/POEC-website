...
if ($jobs) { 
	...
	foreach ($jobs as $job) {
		...
		$contents .=  '<tr id="mc_field_row"  class="'.$trclass[$isodd].'">'; $contents .= '<td  width="'.$colwidth.'">';
			 $contents .=  '<span id="themeanchor"><a class="anchor" href='.$j_l.'><u><strong>'
	...
	if ($sliding == 1) {
		...
		if($slidingdirection == 1 ){
			...
			$contents =  '<marquee id="mod_topjsjobs"  direction="up" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
			...
			$contents =  '<marquee id="mod_topjsjobs"  scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
		}
		$contents .= '
		<script type="text/javascript" language=Javascript>
			jQuery(document).ready(function(){
				jQuery("marquee#mod_topjsjobs").marquee("pointer").mouseover(function () {
