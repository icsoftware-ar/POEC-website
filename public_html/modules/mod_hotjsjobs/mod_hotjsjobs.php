...
//        $viewall = '<div id="viewall" width="100%" align="center"><a href="index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=listnewestjobs&Itemid='.$itemid.'">'.JText::_('JS_VIEW_ALL').'</a></div>';
//        $contents .=$viewall;
	echo $contents;
