...
if ($jslibrary == "mootools") {
	...
	$template_vertex = "yes";
		...
		<?php }
		$doc->addCustomTag('<script src="'.JURI::base().'templates/'.$template_name.'/html/mod_s5_image_and_content_fader/js/jd.gallery.jquery.js" type="text/javascript"></script>');
	...
	//]]></script>
			...
			<script type="text/javascript">
				...
				window.myGallery = new gallery(jQuery('#myGallery'), {
					...
					jQuery('#myGallery_bottom').bind('mouseover',function(){window.myGallery.clearTimer();});
					jQuery('#myGallery_bottom').bind('mouseout',function(){window.myGallery.prepareTimer();});
			}
	...
	<?php			
		...
		$doc->addCustomTag('<script language="javascript" type="text/javascript">var s5_dropdowntext = "'.$s5_dropdowntext.'";</script>');
		$doc->addCustomTag('<script src="'.JURI::base().'templates/'.$template_name.'/html/mod_s5_image_and_content_fader/js/jd.gallery.js" type="text/javascript"></script>');
