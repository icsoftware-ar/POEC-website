...
var gallery =window.gallery= function(element, options) {
   ...
   // start jv
	...
	gallery.prototype.initInfoSlideshow= function() {
		...
		var myGallery_bottom = document.getElementById("myGallery_bottom");
		this.slideInfoZone_outer = new morphx($('<div class="slideInfoZone_outer"></div>').appendTo($(myGallery_bottom)));
		this.slideInfoZone = new morphx($('<div class="slideInfoZone"></div>').appendTo($(this.slideInfoZone_outer.element)).css({'opacity':0}));
		this.slideInfoZoneInner = new morphx($('<div id="slideInfoZoneInner"></div>').appendTo(this.slideInfoZone.element));
		var slideInfoZoneTitle = $('<h2></h2>').appendTo(this.slideInfoZoneInner.element);
		var slideInfoZoneDescription = $('<p></p>').appendTo(this.slideInfoZoneInner.element);
