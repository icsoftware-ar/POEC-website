...
<?php }else{ ?>
	<div id="toppanel">
		<div id="tp_header" <?php if($this->config['topimage'] == 0) echo 'style="background:none;"';?>>
			<span id="tp_title"><?php echo $this->config['title'];?></span>
			<span id="tp_curloc">
				<?php echo JText::_('JS_CUR_LOC'); ?> : <a href="index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resumebycategory&Itemid=<?php echo $this->Itemid; ?>" class="curloclnk"><?php echo JText::_('JS_RESUME_BY_CATEGORY'); ?></a> > <?php echo JText::_('JS_RESUME_BY_CATEGORY'); ?>
			</span>
		</div>
		<div id="tp_links">
			<?php 
		...
		<div id="tp_heading">
			<span id="tp_headingtext">
				...
				<span id="tp_headingtext_center"><?php echo JText::_('JS_RESUME_BY_CATEGORY').' '.$this->categoryname; ?></span>
...
if ($this->userrole->rolefor == 1) { // employer
	//$link = 'index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resume_bycategory&cat='.$this->catid.'&Itemid='.$this->Itemid;
	$link = 'index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resume_bycategory&cat='.$this->resumes[0]->aliasid.'&Itemid='.$this->Itemid;
...
<?php
					...
					<div id="rl_maindiv" class="<?php echo $tdclass[$isodd];$isodd = 1 - $isodd;?>">
						...
						<div id="rl_datadiv">
							...
							<div id="rl_buttondatediv">
								<div id="rl_button">
										<?php $link = 'index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=view_resume&vm=10&rd='.$resume->resumealiasid.'&cat='.$this->catid.'&Itemid='.$this->Itemid; ?>
		...
		?>
	<form action="<?php echo JRoute::_('index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resume_bycategory&Itemid='.$this->Itemid); ?>" method="post">
