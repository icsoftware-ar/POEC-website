	...
	<div id="toppanel">
		<div id="tp_header" <?php if($this->config['topimage'] == 0) echo 'style="background:none;"';?>>
			...
			<span id="tp_curloc">
				<?php if ($this->config['cur_location'] == 1) {
						echo JText::_('JS_CUR_LOC'); ?> : <a href="index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=empmessages&Itemid=<?php echo $this->Itemid; ?>" class="curloclnk"><?php echo JText::_('JS_MESSAGES'); ?></a> > <?php echo JText::_('JS_JOB_MESSAGES');
				} ?>
			</span>
		</div>
		<div id="tp_links">
		...
		<div id="tp_heading">
			<span id="tp_headingtext">
				...
				<span id="tp_headingtext_center"><?php echo JText::_('JS_JOB_MESSAGES');  ?></span>
...
<form action="index.php" method="post" name="adminForm">
	<table cellpadding="0" cellspacing="0" border="0" width="100%" >
		...
		if ( isset($this->messages) ){?>
                    <tr id="mc_title_row">
                            <td width="30%" class="sectionheadline"><?php echo JText::_('JS_TITLE'); ?></td>
                            <td width="30%" class="sectionheadline"><?php echo JText::_('JS_JOB_SEEKER'); ?></td>
                            <td width="20%" class="sectionheadline"><?php echo JText::_('JS_RESUME'); ?></td>
                            <td width="20%" class="sectionheadline"></td>
                    </tr>
                    <?php foreach($this->messages as $message)	{
                            $isodd = 1 - $isodd; ?>
                            <tr id="mc_field_row" class="<?php echo $tdclass[$isodd]; ?>">
                                        <td ><?php echo $message->title;?></td>
                                        <td ><?php echo $message->first_name; if ($message->middle_name) echo ' '.$message->middle_name; echo ' '.$message->last_name; ?></td>
                                        <td ><?php echo $message->application_title;?></td>
                                            <td nowrap>
                                                    <?php $link = 'index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=send_message&bd='.$message->jobid.'&rd='.$message->resumealiasid.'&vm=2&Itemid='.$this->Itemid; ?>
                                                    <a id="button" class="button minpad"href="<?php echo $link?>" class="" title="<?php echo JText::_('JS_MESSAGES'); ?>">
...
<form action="<?php echo JRoute::_('index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=job_messages&bd='.$this->messages[0]->jobid.'&Itemid='.$this->Itemid); ?>" method="post">
