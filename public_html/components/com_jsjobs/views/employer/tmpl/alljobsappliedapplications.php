 ...
 * Created on:	Jan 11, 2009
 ^
 + Project: 		JS Jobs
 * File Name:	views/employer/tmpl/alljobsappliedapplication.php
 ^ 
	...
	<div id="toppanel">
		<div id="tp_header" <?php if($this->config['topimage'] == 0) echo 'style="background:none;"';?>>
			...
			<span id="tp_curloc">
				<?php if ($this->config['cur_location'] == 1) {
					echo JText::_('JS_CUR_LOC'); ?> : <?php echo JText::_('JS_APPLIED_RESUME');
				} ?>
			</span>
		</div>
		<div id="tp_links">
		...
		<div id="tp_heading">
			<span id="tp_headingtext">
				...
				<span id="tp_headingtext_center"><?php echo JText::_('JS_APPLIED_RESUME');  ?></span>
...
?>
	...
	<table cellpadding="1" cellspacing="0" border="0" width="100%" >
		<tr  id="mc_title_row" class="<?php echo $this->theme['sortlinks']; ?>" height="17" valign="center">
			<td class="sectionheadline" nowrap><span id="mc_title_anchor"><a class="mc_title_anchor" href="<?php echo $link?>&sortby=<?php echo $this->sortlinks['title']; ?>"><?php echo JText::_('JS_TITLE'); ?></a></span><?php if ($this->sortlinks['sorton'] == 'title') { ?> <img src="<?php echo $img ?>"> <?php } ?></td>
			<td class="sectionheadline" nowrap><span id="mc_title_anchor"><a class="mc_title_anchor" href="<?php echo $link?>&sortby=<?php echo $this->sortlinks['category']; ?>"><?php echo JText::_('JS_CATEGORY'); ?></a></span><?php if ($this->sortlinks['sorton'] == 'category') { ?> <img src="<?php echo $img ?>"> <?php } ?></td>
			<td class="sectionheadline" nowrap><span id="mc_title_anchor"><a class="mc_title_anchor" href="<?php echo $link?>&sortby=<?php echo $this->sortlinks['jobtype']; ?>"><?php echo JText::_('JS_JOBTYPE'); ?></a></span><?php if ($this->sortlinks['sorton'] == 'jobtype') { ?> <img src="<?php echo $img ?>"> <?php } ?></td>
			<td class="sectionheadline" nowrap><span id="mc_title_anchor"><a class="mc_title_anchor" href="<?php echo $link?>&sortby=<?php echo $this->sortlinks['jobstatus']; ?>"><?php echo JText::_('JS_JOBSTATUS'); ?></a></span><?php if ($this->sortlinks['sorton'] == 'jobstatus') { ?> <img src="<?php echo $img ?>"> <?php } ?></td>
			<td class="sectionheadline" nowrap><span id="mc_title_anchor"><a class="mc_title_anchor" href="<?php echo $link?>&sortby=<?php echo $this->sortlinks['created']; ?>"><?php echo JText::_('JS_DATEPOSTED'); ?></a></span><?php if ($this->sortlinks['sorton'] == 'created') { ?> <img src="<?php echo $img ?>"> <?php } ?></td>
			<td class="sectionheadline <?php echo $this->theme['sortlinks']; ?>" ><strong><?php echo JText::_('JS_RESUME'); ?>	</strong></td>
		</tr>
			<?php 
		...
		foreach($this->jobs as $app)	{ 
			...
			<tr id="mc_field_row" class="<?php echo $tdclass[$isodd]; ?>" height="20">
				...
				<td class="maintext"><?php echo date($this->config['date_format'],strtotime($app->created)); ?></td>
				<td class="maintext" nowrap>
					<?php $link = 'index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=job_appliedapplications&bd='.$app->aliasid.'&Itemid='.$this->Itemid; ?>
					<a id="button" class="button minpad" href="<?php echo $link?>"><?php echo JText::_('JS_RESUME'); echo ' ('.$app->appinjob.')'; ?></a>
				</td>
