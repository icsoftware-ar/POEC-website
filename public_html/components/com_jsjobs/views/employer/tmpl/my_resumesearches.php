	...
	<div id="toppanel">
		<div id="tp_header" <?php if($this->config['topimage'] == 0) echo 'style="background:none;"';?>>
			...
			<span id="tp_curloc">
				<?php if ($this->config['cur_location'] == 1) {
						echo JText::_('JS_CUR_LOC'); ?> : <?php echo JText::_('JS_RESUME_SAVE_SEARCHES');
				} ?>
			</span>
		</div>
		<div id="tp_links">
		...
		<div id="tp_heading">
			<span id="tp_headingtext">
				...
				<span id="tp_headingtext_center"><?php echo JText::_('JS_RESUME_SAVE_SEARCHES');  ?></span>
...
<form action="index.php" method="post" name="adminForm">
	<table cellpadding="0" cellspacing="0" border="0" width="100%" >
		<tr id="mc_title_row" class="<?php echo $this->theme['sortlinks']; ?>" height="16" valign="center">
			<td width="75%" class="sectionheadline"><?php echo JText::_('JS_TITLE'); ?></td>
			<td width="15" class="sectionheadline"><?php echo JText::_('JS_CREATED'); ?></td>
		...
		$i=0;
			...
			$i++;
				...
				<tr id="mc_field_row" height="20" class="<?php echo $tdclass[$isodd]; ?>" > 
					<td><?php echo $search->searchname;	?></td>
					<td><?php echo date($this->config['date_format'],strtotime($search->created));	?></td>
					<td align="center" valign="middle">
						<a href="index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=viewresumesearch&rs=<?php echo $search->id; ?>&Itemid=<?php echo $this->Itemid; ?>">
	...
	<form action="index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=my_resumesearches&Itemid=<?php echo $this->Itemid; ?>" method="post">
