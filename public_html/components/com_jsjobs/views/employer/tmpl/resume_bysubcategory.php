...
if (isset($this->resume[0])){
			...
			$catlink = JRoute::_("index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resume_bycategory&cat=". $this->resume[0]->cat_id."&Itemid=".$this->Itemid);
			...
			$catlink = JRoute::_("index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resume_bycategory&cat=". $this->subcategorytitle->cat_id."&Itemid=".$this->Itemid);
...
<?php }else{ ?>
	<div id="toppanel">
		<div id="tp_header" <?php if($this->config['topimage'] == 0) echo 'style="background:none;"';?>>
			<span id="tp_title"><?php echo $this->config['title'];?></span>
			<span id="tp_curloc">
				<?php echo JText::_('JS_CUR_LOC'); ?> : <a href="index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resumebycategory&Itemid=<?php echo $this->Itemid; ?>" class="curloclnk"><?php echo JText::_('JS_RESUME_BY_CATEGORY'); ?></a> > <a href="<?php echo $catlink; ?>" class="curloclnk"><?php echo JText::_('JS_RESUME_BY_CATEGORY'); ?></a>  > <?php echo JText::_('JS_SUB_CATEGORY'); ?>
			</span>
		</div>
		<div id="tp_links">
			<?php 
...
if ($this->userrole->rolefor == 1) { // employer
	...
	$link = "index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resume_bysubcategory&resumesubcat=". $this->resume[0]->aliasid."&Itemid=".$this->Itemid;
...
<?php
					...
					<div id="rl_maindiv" class="<?php echo $tdclass[$isodd];$isodd = 1 - $isodd;?>">
						...
						<div id="rl_datadiv">
							...
							<div id="rl_buttondatediv">
								<div id="rl_button">
										<?php $link = 'index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=view_resume&vm=11&rd='.$resume->resumealiasid.'&cat='.$categoryid.'&Itemid='.$this->Itemid; ?>
										...
										<a id="button"class="button minpad" href="<?php echo $link?>"><strong><?php echo JText::_('JS_VIEW_COVER_LETTERS'); ?></strong></a>
										*/ ?>
								</div>
		...
		$querystring='&resumesubcat='.$this->resume[0]->aliasid.'&Itemid='.$this->Itemid;
		 ?>
	<form action="<?php echo JRoute::_('index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=resume_bysubcategory&Itemid='.$this->Itemid); ?>" method="post">
