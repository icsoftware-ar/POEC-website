	...
	<div id="toppanel">
		<div id="tp_header" <?php if($this->config['topimage'] == 0) echo 'style="background:none;"';?>>
			...
			<span id="tp_curloc">
				<?php if ($this->config['cur_location'] == 1) {
						echo JText::_('JS_CUR_LOC'); ?> : <a href="index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=myfolders&Itemid=<?php echo $this->Itemid; ?>" class="curloclnk" ><?php echo JText::_('JS_MY_FOLDERS'); ?></a> > <?php echo JText::_('JS_VIEW_FOLDER');
				} ?>
			</span>
		</div>
		<div id="tp_links">
		...
		<div id="tp_heading">
			<span id="tp_headingtext">
				...
				<span id="tp_headingtext_center"><?php echo JText::_('JS_FOLDER_INFO');  ?></span>
				<span id="tp_headingtext_right"></span>				
			</span>
		</div>
	</div>
<?php if( isset($this->folder)){ ?>
	<table cellpadding="0" cellspacing="0" border="0" width="100%" >
      <tr>
		...
		<tr id="mc_field_row" class="<?php echo $this->theme[$trclass[$isodd]]; ?>"><td width="7"></td>
			<td width="30%"class="maintext"><b><?php echo JText::_('JS_NAME'); ?></b></td>
			<td class="maintext"><?php echo $this->folder->name; ?></td>
		</tr>
		<tr id="mc_field_row"  class="<?php echo $this->theme[$trclass[$isodd]]; ?>"><td width="7"></td>
			<td class="maintext"><b><?php echo JText::_('JS_DESCRIPTION'); ?></b></td>
			<td class="maintext"><?php echo $this->folder->decription; ?></td>
		</tr>
    </table>
<?php }else { ?>
	<div id="errormessagedown"></div>
