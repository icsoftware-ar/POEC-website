	...
	<div id="toppanel">
		<div id="tp_header" <?php if($this->config['topimage'] == 0) echo 'style="background:none;"';?>>
			...
			<span id="tp_curloc">
				<?php if ($this->config['cur_location'] == 1) {
					echo JText::_('JS_CUR_LOC'); ?> : <?php echo JText::_('JS_JOB_CATEGORIES');
				} ?>
			</span>
		</div>
		<div id="tp_links">
		...
		<div id="tp_heading">
			<span id="tp_headingtext">
				...
				<span id="tp_headingtext_center"><?php echo JText::_('JS_JOB_CATEGORIES');  ?></span>
	...
	<table cellpadding="3" cellspacing="0" border="0" width="100%" >
		...
		if ( isset($this->application) ){
			foreach($this->application as $category)	{
									...
									$lnks = 'index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=list_jobs&jobcat='. $category->aliasid .'&Itemid='.$this->Itemid;
                                    ?>
