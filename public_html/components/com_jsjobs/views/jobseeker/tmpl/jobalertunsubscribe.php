	...
	<div id="toppanel">
		<div id="tp_header" <?php if($this->config['topimage'] == 0) echo 'style="background:none;"';?>>
			...
			<span id="tp_curloc">
				<?php if ($this->config['cur_location'] == 1) {
					echo JText::_('JS_CUR_LOC'); ?> : <?php echo JText::_('JS_JOB_ALERT_UNSUBSCRIBE');
				} ?>
			</span>
		</div>
		<div id="tp_links">
		...
		<div id="tp_heading">
			<span id="tp_headingtext">
				...
				<span id="tp_headingtext_center"><?php echo JText::_('JS_UNSUBSCRIBE_JOB_ALERT');  ?></span>
...
<?php
$printform = 0;
if (isset($this->userrole)) if ($this->userrole->rolefor == 2) { // job seeker
	$printform = 1;
...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data"  onSubmit="return myValidate(this);">
    <table cellpadding="5" cellspacing="0" border="0" width="100%" class="adminform">
		...
		<?php if($this->email){?>
			<td><input class="inputbox required validate-email" type="text" name="contactemail" id="contactemail" size="40" maxlength="100" value="<?php  echo $this->email; ?>" />
			</td>
		<?php  }else{ ?>
			<td><input class="inputbox required validate-email" type="text" name="contactemail" id="contactemail" size="40" maxlength="100" value="" />
			</td>
		<?php  }?>
		  </tr>
	<tr>
		<td colspan="2" align="center">
		<input id="button" class="button" type="submit" name="submit_app" value="<?php echo JText::_('JS_UNSUBSCRIBE'); ?>" />
		</td>
	</tr>
    </table>
...
<?php 
	...
	<div id="errormessagedown"></div>
	<div id="errormessage" class="errormessage">
		<div id="message"><b><?php echo JText::_('JS_YOU_ARE_NOT_ALLOWED_TO_UNSUBSCRIBE_JOBALERT');?></b></div>
	</div>
<?php
