 ...
 */
 ...
 global $mainframe;
 $link = 'index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=purchasehistory&Itemid='.$this->Itemid;
...
?>
                            ...
                            <table cellpadding="0" cellspacing="1" border="0" width="100%">
                                    ...
                                    <tr>
											...
											<span id="sectionheadline_left"></span>
												<span id="anchor"><a class="anchor" href="index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=package_details&gd=<?php echo $package->id; ?>&Itemid=<?php echo $this->Itemid; ?>"><?php echo $package->title; ?></a></span>
	...
	<form action="<?php echo JRoute::_('index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=purchasehistory&Itemid='.$this->Itemid); ?>" method="post">
