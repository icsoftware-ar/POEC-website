 ...
 */
 ...
 global $mainframe;
 $link = 'index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=jsmessages&Itemid='.$this->Itemid;
		...
		?>
                    ...
                    <?php foreach($this->messages as $message)	{
                            ...
                            <tr id="mc_field_row" class="<?php echo $tdclass[$isodd]; ?>">
                                        ...
                                        <td ><?php $link = 'index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=view_company&vm=6&md='.$message->companyaliasid.'&Itemid='.$this->Itemid; ?>
                                        ...
                                        <td ><?php echo date($this->config['date_format'],strtotime($message->created)); ?></td>
                                            <td nowrap>
                                                    <?php $link = 'index.php?option=com_jsjobs&c=jsjobs&view=employer&layout=send_message&bd='.$message->jobid.'&rd='.$message->resumealiasid.'&vm=3&Itemid='.$this->Itemid; ?>
...
<form action="<?php echo JRoute::_('index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=jsmessages&Itemid='.$this->Itemid); ?>" method="post">
