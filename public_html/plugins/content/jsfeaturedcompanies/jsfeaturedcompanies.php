						...
						if ($sliding == 1) {
							...
							<script type="text/javascript" language=Javascript>
								jQuery(document).ready(function(){
									jQuery("marquee#plg_jsfeaturedcompanies").marquee("pointer").mouseover(function () {
							...
							$contents =  '<marquee id="plg_jsfeaturedcompanies"  scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
						}
						//sce
...
*/
						...
						if ($sliding == 1) {
							...
							$contents =  '<marquee id="plg_jsfeaturedcompanies" direction="up" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
