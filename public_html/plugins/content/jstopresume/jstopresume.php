        ...
        protected function _load( $position, $style=-2 )
        {
				...
				if (isset($resumes)) { 
					...
					foreach ($resumes as $resume) {
						...
						if ($jobtype == 1) $contents .= '<small>'.$jobtypetitle.'Type: '.$resume->jobtypetitle.'</small><br />';	
				...
				if ($sliding == 1) {                    
					...
					if($slidingdirection == 1 ){
						...
						$contents =  '<marquee id="plg_jstopresume"  direction="up" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
						...
						$contents =  '<marquee id="plg_jstopresume" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start()";>'.$contents.'</marquee>';
					}	
					$contents .= '
					<script type="text/javascript" language=Javascript>
						jQuery(document).ready(function(){
							jQuery("marquee#plg_jstopresume").marquee("pointer").mouseover(function () {
